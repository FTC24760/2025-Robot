...
public class BlueFrontScoring extends AutoExample {
    ...
    public static Pose intake1Pose = new Pose(144-85, 84, Math.toRadians(180-0));
    public static Pose intake1GrabPose = new Pose(144-116, 84, Math.toRadians(180-0));
    ...
    public static Pose intake3Pose = new Pose(144-85, 36, Math.toRadians(180-0));
